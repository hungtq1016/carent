          ...
          <div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
            ...
            <div class="mt-14 flex justify-end gap-8 sm:-mt-44 sm:justify-start sm:pl-20 lg:mt-0 lg:pl-0">
              <div
                ...
                <div class="relative">
                  <img src="https://picsum.photos/180/300?random=1" alt="1"
              ...
              <div class="mr-auto w-44 flex-none space-y-8 sm:mr-0 sm:pt-52 lg:pt-36">
                <div class="relative">
                  <img src="https://picsum.photos/180/300?random=2" alt="2"
                    class="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg" />
                  <div class="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10" />
                </div>
                <div class="relative">
                  <img src="https://picsum.photos/180/300?random=3" alt="3"
                    class="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg" />
                  <div class="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10" />
                </div>
              </div>
              <div class="w-44 flex-none space-y-8 pt-32 sm:pt-0">
                <div class="relative">
                  <img src="https://picsum.photos/180/300?random=4" alt="4"
                    class="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg" />
                  <div class="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10" />
                </div>
                <div class="relative">
                  <img src="https://picsum.photos/180/300?random=5" alt="5"
                    class="aspect-[2/3] w-full rounded-xl bg-gray-900/5 object-cover shadow-lg" />
                  <div class="pointer-events-none absolute inset-0 rounded-xl ring-1 ring-inset ring-gray-900/10" />
                </div>
              </div>
        ...
        <div class="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
          <div class="lg:w-full lg:max-w-2xl lg:flex-auto">
            ...
            <div class="mt-10 max-w-xl text-base leading-7 text-gray-700">
              ...
              Carent - Lựa chọn hoàn hảo cho mọi nhu cầu di chuyển <br>
              Carent - Dịch vụ thuê xe trọn gói, tiện lợi và nhanh chóng
            </div>
          </div>
...
const values = [
  {
    name: 'Tuyệt Vời',
    description:
      'Mang đến trải nghiệm di chuyển tuyệt vời.',
  },
  {
    name: 'Tin Tưởng',
    description:
      ' Niềm tin và sự hài lòng của khách hàng là mục tiêu hàng đầu.',
  },
  {
    name: 'Tiếp bước',
    description:
      'Luôn đồng hành cùng khách hàng trên mọi nẻo đường.',
  },
]
const team = [
  {
    name: 'Trần Quốc Hưng',
    role: 'Web Developer / (Laravel-VueJS)',
    phone: '+84 865264325',
