                    ...
                    <form class="space-y-6" action="#" method="POST">
                        ...
                        <div>
                            <div class="flex items-center justify-between">
                                <label for="password"
                                    ...
                                    Khẩu</label>
                                <div class="text-sm">
                                    <a href="#" class="font-semibold text-amber-600 hover:text-amber-500">Quên mật khẩu?</a>
                                </div>
                            </div>
                            <div class="mt-2">
                        ...
                        <div>
                            <button type="button" @click="submit"
                                class="flex w-full justify-center rounded-md bg-amber-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-amber-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-600">Đăng
                                Nhập</button>
                        </div>
                    </form>
                </div>
