<template>
    <section class="py-2 sticky top-0 bg-white z-10 shadow dark:bg-zinc-900/90 ">
        <div class="max-w-screen-xl xl:mx-auto lg:mx-8 md:mx-6 mx-4">
            <div class="flex items-center gap-x-2 justify-between lg:justify-start">
                <button @click="() => carsStore.query = carsStore.absoluteQuery"
                    class="p-1 border rounded-md border-gray-600 hover:border-amber-600 duration-300 group dark:border-slate-100 dark:hover:border-gray-400">
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="w-6 h-6 fill-gray-600 group-hover:fill-amber-600 duration-300 dark:fill-slate-100 dark:group-hover:fill-gray-400"
                        viewBox="0 0 512 512">
                        <path
                ...
                <div class="hidden lg:block flex-auto">
                    <div class="flex gap-x-2 border-l-2 border-amber-600 pl-2">
                        ...
                        <div>
                            <VueDatePicker class="date-find" :enable-time-picker="false" cancelText="Hủy" selectText="Gửi"
            ...
            <DialogPanel
                ...
                <div class="mt-6 flow-root">
                    <div class="-my-6 divide-y divide-gray-500/10">
                        <div class="flex flex-col gap-2 divide-y-[1px]">
                        <FilterItem v-for="(filter, index) in filters" :key="index" :filter="filter" />
                        <div>
                            <VueDatePicker class="date-find" :enable-time-picker="false" cancelText="Hủy" selectText="Gửi"
                                fixed-start min-range="1" format="dd-MM-yyyy" :multi-calendars="{ solo: true }" id="date"
...
<style >
.date-find .dp__input {
    @apply hover:!border-amber-600 !rounded-md border-none lg:border !py-2 !border-gray-600 lg:!py-1 !pl-10 !pr-5 dark:bg-transparent dark:!border-slate-100 dark:hover:!border-gray-400 dark:!text-gray-100 dark:hover:!text-gray-400
}
...
.dp__input_wrap svg {
    @apply fill-gray-600 dark:!fill-slate-100 !px-0
}
