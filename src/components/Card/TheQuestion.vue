<template>
    <div class="relative group">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
         class="w-4 h-4 fill-gray-600 dark:fill-gray-100" viewBox="0 0 302.967 302.967" xml:space="preserve">
            <g>
                <g>
                    <g>
                        <path class="fill-gray-600 dark:fill-gray-100"
        ...
        <div class="absolute bottom-0 -right-2  w-60 translate-x-full  hidden group-hover:inline">
            <div class="w-fit bg-white p-1 rounded-md text-xs text-gray-600 dark:shadow-none shadow" v-html="answer"></div>
        </div>
    </div>
</template>
