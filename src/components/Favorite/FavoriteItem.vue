<template>
  <li
    class="flex justify-between gap-x-6 p-5 bg-gray-50 dark:bg-zinc-700 hover:shadow dark:shadow-zinc-400 duration-300 rounded-md">
    <RouterLink :to="`/car/${favorite.slug}/id/${favorite.id}`">
      <div class="flex min-w-0 gap-x-4">
        <img class="h-32 w-32 flex-none rounded-md object-cover" :src="IMG_URL + favorite.image.path" alt="" />
